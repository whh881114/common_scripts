...
# 设置scm_node属性
scm_node.set("class", "hudson.plugins.git.GitSCM")
scm_node.set("plugin", "git@3.10.0")

# 然后再创建子元素
scm_sub_elem1 = ET.SubElement(scm_node, 'configVersion')
scm_sub_elem1.text = '2'

scm_sub_elem2 = ET.SubElement(scm_node, 'userRemoteConfigs')
...
scm_sub_elem3 = ET.SubElement(scm_node, 'branches')
...
scm_sub_elem4 = ET.SubElement(scm_node, 'doGenerateSubmoduleConfigurations')
scm_sub_elem4.text = 'false'

scm_sub_elem5 = ET.SubElement(scm_node, 'submoduleCfg')
scm_sub_elem5.set("class", "list")

scm_sub_elem6 = ET.SubElement(scm_node, 'extensions')
